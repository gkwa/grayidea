...
import (
	...
	"github.com/gkwa/grayidea/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.grayidea.yaml)")
